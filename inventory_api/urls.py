...
urlpatterns = [
    ...
    path('agent-installer/', views.agent_installer_release_status, name='agent-installer-status'),
    ...
    path('agents/commands/<int:command_id>/cancel/', views.ServiceAgentViewSet.as_view({'post': 'cancel_command'}), name='agents-command-cancel-direct'),
    path('agents/commands/<int:command_id>/', views.ServiceAgentViewSet.as_view({'delete': 'delete_command'}), name='agents-command-delete-direct'),
    ...
    path('installers/agent/', views.agent_installer_release_status, name='agent-installer-status-alt'),
