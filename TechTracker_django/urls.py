...
urlpatterns = [
    ...
    path('api/agents/commands/<int:command_id>/cancel/', inventory_views.ServiceAgentViewSet.as_view({'post': 'cancel_command'}), name='root-agents-command-cancel'),
    path('api/agents/commands/<int:command_id>/', inventory_views.ServiceAgentViewSet.as_view({'delete': 'delete_command'}), name='root-agents-command-delete'),
